    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <a class="btn btn-outline-primary rounded-pill " href="{{ Route('transaction.create') }}"><i class="fa-solid fa-plus"></i>Add Transaction</a>
            </div>
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-outline-warning icon icon-left rounded-pill"><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                                <button class="btn btn-outline-danger icon icon-left rounded-pill"><i class="fa-solid fa-trash"></i></i> Delete</button>
                            </td>
                        @endforeach
                    </tbody>
                </table>
